...
export default function ResearchCard({ research }) {
  ...
  return (
    <Link
      ...
      className="group relative rounded-2xl p-5 bg-gradient-to-br from-card to-card/40 border border-border hover:border-white/25 transition-all hover:-translate-y-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
    >
