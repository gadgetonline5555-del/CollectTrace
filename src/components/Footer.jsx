      ...
      <div className="max-w-7xl mx-auto px-6 py-10 grid md:grid-cols-3 gap-8 text-sm">
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="font-display font-bold text-foreground">Collect Trace</span>
          </div>
          <p className="text-muted-foreground leading-relaxed">{t("footer.tagline")}</p>
        </div>
        <div>
          <h4 className="text-foreground font-semibold mb-3">{t("footer.contents")}</h4>
        ...
        <div>
          <h4 className="text-foreground font-semibold mb-3">{t("footer.notice_h")}</h4>
