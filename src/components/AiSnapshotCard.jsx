...
export default function AiSnapshotCard({ snapshot, live = false }) {
  ...
  return (
    <article className="rounded-3xl border border-border bg-card/60 overflow-hidden">
      ...
      <div className="p-6 space-y-6">
        {snapshot.summary && (
          <p className="text-muted-foreground text-lg leading-relaxed border-l-2 border-violet-400 pl-4 italic">{snapshot.summary}</p>
        )}
