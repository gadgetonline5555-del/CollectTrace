      ...
      <div className="mt-8">
        {!access ? (
          <div className="rounded-3xl border border-amber-400/30 bg-amber-500/5 p-8 text-center">
            ...
            <h2 className="font-display text-2xl font-bold text-white">{t("reader.lock_h", { plan: plan.name[lang] })}</h2>
            <p className="text-slate-400 mt-2 mb-6">{t("reader.lock_p", { price: plan.priceLabel[lang] })}</p>
