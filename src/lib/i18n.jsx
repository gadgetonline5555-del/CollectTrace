...
const DICT = {
  ...
  "nav.screener": { jp: "銘柄スクリーナー", en: "Screener" },
  ...
  "set.subscription": { jp: "サブスクリプション", en: "Subscription" },
  "set.sub_desc": { jp: "現在のプランの解約（期間終了時に更新停止）ができます。期間終了までプランは有効です。", en: "Cancel your plan. It stays active until the current period ends." },
  "set.sub_cancel_btn": { jp: "サブスクリプションを解約する", en: "Cancel subscription" },
  "set.sub_cancel_confirm_t": { jp: "解約しますか？", en: "Cancel subscription?" },
  "set.sub_cancel_confirm_d": { jp: "期間終了までプランは有効です。それ以降は更新されず、フリープランに移行します。", en: "Your plan stays active until the period ends, then switches to Free." },
  "set.sub_cancel_confirm": { jp: "解約する", en: "Cancel plan" },
  "set.sub_canceling": { jp: "処理中…", en: "Processing…" },
  "set.sub_cancel_done": { jp: "解約予約が完了しました", en: "Cancellation scheduled" },
  "set.sub_cancel_done_desc": { jp: "期間終了までプランは有効です。", en: "Your plan stays active until the period ends." },
  "set.sub_no_sub": { jp: "有効なサブスクリプションが見つかりません", en: "No active subscription found" },
  "set.sub_err": { jp: "解約処理に失敗しました", en: "Cancellation failed" },

  "footer.tagline": { jp: "データで読み、調査で深める。次世代の投資調査支援プラットフォーム。", en: "Read the data, deepen through research. A next-gen investment research platform." },
  "footer.contents": { jp: "提供内容", en: "What we offer" },
  "footer.c1": { jp: "AI投資調査", en: "AI investment research" },
  ...
  "hero.badge": { jp: "データで読む × 調査で勝つ — 次世代の投資調査支援", en: "Read the data × Win through research — next-gen investment research" },
  ...
  "hero.p": { jp: "初心者はAI調査で投資の本質を直感し、プロは機関レベルの調査レポートで銘柄を深掘り。4つのプラン階層で、調査の深度をシームレスに拡げる。", en: "Beginners intuit the essence of investing through AI research; professionals dive deep with institution-grade reports. Four tiers seamlessly scale the depth of your research." },
  "hero.cta1": { jp: "スクリーナーを試す", en: "Try the screener" },
  ...
  "stat.screener.label": { jp: "銘柄スクリーナー", en: "Stock screener" },
  "stat.screener.value": { jp: "全銘柄", en: "All stocks" },
  "stat.screener.sub": { jp: "リアルタイム絞込", en: "real-time filters" },

  "screen.badge": { jp: "銘柄スクリーナー", en: "Stock Screener" },
  "screen.h": { jp: "銘柄スクリーナー", en: "Stock Screener" },
  "screen.p": { jp: "セクター・格付け・上値余地で銘柄を絞り込み、調査レポートを比較します。", en: "Filter stocks by sector, rating and upside, then compare research reports." },
  "screen.promo_h": { jp: "条件で銘柄を絞り込む", en: "Screen stocks by your criteria" },
  "screen.promo_p": { jp: "セクター・格付け・上値余地を組み合わせて、調査対象の銘柄から条件に合う投資候補を即座に抽出。", en: "Combine sector, rating and upside to instantly surface investment candidates that match your criteria." },
  "screen.promo_btn": { jp: "スクリーナーを開く", en: "Open screener" },
  "screen.filter_sector": { jp: "セクター", en: "Sector" },
  "screen.filter_rating": { jp: "格付け", en: "Rating" },
  "screen.filter_upside": { jp: "上値余地(%)以上", en: "Min upside (%)" },
  "screen.sort": { jp: "並び順", en: "Sort" },
  "screen.sort_upside": { jp: "上値余地順", en: "By upside" },
  "screen.sort_current": { jp: "現在値順", en: "By current price" },
  "screen.sort_target": { jp: "目標株価順", en: "By target price" },
  "screen.all": { jp: "すべて", en: "All" },
  "screen.col_ticker": { jp: "ティッカー", en: "Ticker" },
  "screen.col_title": { jp: "銘柄", en: "Name" },
  "screen.col_sector": { jp: "セクター", en: "Sector" },
  "screen.col_rating": { jp: "格付け", en: "Rating" },
  "screen.col_current": { jp: "現在値", en: "Current" },
  "screen.col_target": { jp: "目標株価", en: "Target" },
  "screen.col_upside": { jp: "上値余地", en: "Upside" },
  "screen.results": { jp: "{n}件", en: "{n} results" },
  "screen.reset": { jp: "リセット", en: "Reset" },
  "screen.loading": { jp: "読み込み中…", en: "Loading…" },
  "screen.empty": { jp: "該当する銘柄がありません", en: "No matching stocks" },
  "screen.locked_h": { jp: "スクリーナーはスタータープラン以上", en: "Screener requires Starter or higher" },
  "screen.locked_p": { jp: "セクター・格付け・上値余地で銘柄を絞り込む機能はスタータープラン以上でご利用いただけます。", en: "Filter stocks by sector, rating and upside with a Starter plan or higher." },
